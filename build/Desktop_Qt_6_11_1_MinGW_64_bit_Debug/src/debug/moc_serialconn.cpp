...
namespace {
struct qt_meta_tag_ZN16SerialConnectionE_t {};
} // unnamed namespace

template <> constexpr inline auto SerialConnection::qt_create_metaobjectdata<qt_meta_tag_ZN16SerialConnectionE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SerialConnection, qt_meta_tag_ZN16SerialConnectionE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject SerialConnection::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16SerialConnectionE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16SerialConnectionE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16SerialConnectionE_t>.metaTypes,
    nullptr
} };
...
void SerialConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SerialConnection::*)(QString )>(_a, &SerialConnection::readText, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SerialConnection::*)(QString )>(_a, &SerialConnection::status, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SerialConnection::*)(QString )>(_a, &SerialConnection::error, 2))
            return;
    }
}
...
void *SerialConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16SerialConnectionE_t>.strings))
